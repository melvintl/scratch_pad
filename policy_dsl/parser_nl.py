"""Parse natural-language policy DSL files using textX."""

import os
from textx import metamodel_from_file


GRAMMAR_PATH = os.path.join(os.path.dirname(__file__), "grammar", "policy_nl.tx")


def get_metamodel():
    """Return the textX metamodel for the natural-language policy DSL."""
